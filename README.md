...
**FınTurk Finansal Asistan**, BIST hisse senetleri için kapsamlı analiz, tahmin ve yatırım tavsiyeleri sunan modern bir Streamlit web uygulamasıdır. Yapay zeka destekli chatbot, teknik analiz, portföy yönetimi ve finansal takvim özelliklerini tek platformda birleştirir.
...
### Hedef Kitle
- **Bireysel Yatırımcılar**: BIST hisse senedi piyasasında aktif olan kişiler
...
- **Plotly Grafikleri**: İnteraktif ve dinamik veri görselleştirme

## 🚀 Streamlit Uygulama Özellikleri

### 📱 Ana Sayfalar
- **🏠 Ana Sayfa**: Yapay zeka destekli chatbot ve hızlı analiz
- **💼 Portföy Yönetimi**: Hisse portföyü takibi ve simülasyon
- **📅 Finansal Takvim**: BIST şirket olayları ve takvim
- **📊 Teknik Analiz**: Gelişmiş teknik analiz araçları
- **🔔 Alarm Yönetimi**: Finansal olay uyarıları

### 🤖 Yapay Zeka Chatbot
- **Gemini AI Entegrasyonu**: Google'ın en gelişmiş AI modeli
- **Doğal Dil İşleme**: Türkçe ağırlıklı finansal soru-cevap
- **Akıllı Yanıtlar**: Bağlamsal ve kişiselleştirilmiş tavsiyeler
- **Sohbet Geçmişi**: Oturum bazlı konuşma kaydetme
- **Hızlı Erişim**: Popüler hisseler için tek tıkla analiz

### 📈 Fiyat Tahmini ve Analiz
- **Makine Öğrenmesi Modeli**: XGBoost ile %85+ doğruluk oranı
- **Gerçek Zamanlı Veri**: yfinance API ile canlı hisse verileri
- **Teknik İndikatör Analizi**: RSI, MACD, SMA, Bollinger Bands, Williams %R, ATR
- **Sentiment Analizi**: News API ile haber analizi ve TextBlob duygu analizi
- **Fiyat Düzeltmesi**: Haber sentiment skoruna göre otomatik düzeltme
- **Trend Yönü Belirleme**: Yükseliş/düşüş trendi ve güven seviyesi
...
"THYAO bugün neden düştü?"
"GARAN için teknik analiz yap"
"BIST'te en iyi performans gösteren hisseler hangileri?"
"Risk analizi yap"
"Portföy çeşitlendirmesi neden önemli?"
```

### 📊 Hızlı Analiz (Ana Sayfa)
- **Hisse Seçimi**: Dropdown menüden hisse seçin
- **Analiz Türü**: Fiyat Tahmini, Teknik Analiz, Haber Analizi, Simülasyon
- **Tek Tıkla Analiz**: "Analiz Yap" butonu ile anında sonuç
...
"Risk analizi yap"
"Portföy çeşitlendirme skoru nedir?"
```

### 📅 Finansal Takvim
- **Yaklaşan Olaylar**: BIST şirketlerinin önemli tarihleri
- **Filtreleme**: Tarih, şirket ve olay türüne göre arama
- **Detaylı Bilgi**: Her olay için kapsamlı açıklama

### 📈 Teknik Analiz Sayfası
- **Hisse Seçimi**: KCHOL.IS, THYAO.IS, GARAN.IS, AKBNK.IS
- **Otomatik Analiz**: Tek tıkla kapsamlı teknik analiz
- **Görsel Grafikler**: Plotly ile interaktif grafikler
- **Sinyal Üretimi**: RSI, MACD, Bollinger Bands sinyalleri

### 🔔 Alarm Yönetimi
- **Alarm Oluşturma**: Hisse fiyatı ve olay bazlı uyarılar
- **Alarm Listesi**: Mevcut alarmları görüntüleme ve yönetme
- **Otomatik Bildirimler**: Belirlenen koşullarda uyarı

### 🎯 Popüler Hisse Erişimi (Sidebar)
- **Hızlı Butonlar**: KCHOL, THYAO, GARAN, AKBNK, ASELS, EREGL
- **Tek Tıkla Analiz**: Butona tıklayarak anında fiyat tahmini
- **Otomatik Sohbet**: Seçilen hisse için chatbot yanıtı
